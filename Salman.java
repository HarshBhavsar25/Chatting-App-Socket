...
public class Salman extends JFrame {
    static JPanel p2;
    JTextField t1;
    ...
    private static final Color SENT_MESSAGE_COLOR = new Color(0, 153, 153);
    ...
    private JPanel createHeaderPanel() {
        ...
        ImageIcon profile1 = new ImageIcon("icons/salman.png");
    ...
    private static JPanel createMessagePanel(String message, boolean isSent) {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> new Salman());

        new Thread(() -> {
            Socket s = null;
            try {
                try (ServerSocket ss = new ServerSocket(3434)) {
                    s = ss.accept();
                }
